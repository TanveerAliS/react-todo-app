...
class Content extends Component {
  ...
  onChangeList = (e) =>{
    this.props.handleFilter(e.target.innerText);
            ...
            <div className="col-12 col-md-9 col-lg-7 col-xl-6">
              <div className="card text-center">
                <div className="card-body">
                  ...
                  <p className="card-text">To get started, add some items and due date to your list:</p>
                  <div className="d-inline-block">
                    <Form handleAddItem={this.props.handleAddItem} />
                  </div>
                  </div>
                  <ul className="card-navigation" onClick={this.onChangeList}>
                    <li className={this.props.activePage === "Home" ? 'active' : ''} ><span>Home</span></li>
                    <li className={this.props.activePage === "Completed" ? 'active' : ''}><span>Completed</span></li>
                    <li className={this.props.activePage === "Trash" ? 'active' : ''}><span>Trash</span></li>
                  </ul>
                </div>
            </div>
          </div>
