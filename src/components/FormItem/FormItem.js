    ...
    return (
      <li
        ...
        <div className="text-truncate" onClick={() => this.props.handleItemCompletion(this.props.item)}>
          ...
          <span className="form_item__text">{this.props.item.value}</span><br />
          <span className="form_item__dueDate">{this.props.item.dueDate}</span>
        </div>

        {this.state.displayMenu ? (
          <PropertyBar
            id={this.props.item.id}
            isTrashed={this.props.item.trashed}
